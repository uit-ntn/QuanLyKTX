            ...
            <div class="col-lg-6">
              <div class="text-center my-5">
                ...
                <c:choose>
                  <c:when test="${loggedUser != null}">
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                      <a class="btn btn-primary btn-lg px-4 me-sm-3" href="/user/profile">Account</a>
                      <a class="btn btn-light btn-lg px-4 me-sm-3" href="/user/profile">Shop</a>
                      <a class="btn btn-outline-light btn-lg px-4 me-sm-3">Comment</a>
                      <a class="btn btn-danger btn-lg px-4 me-sm-3" href="/logout">Log out</a>
                    </div>
                  </c:when>
                  <c:otherwise>
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                      <a class="btn btn-primary btn-lg px-4 me-sm-3" href="/login">Đăng nhập</a>
                      <a class="btn btn-outline-light btn-lg px-4" href="/rooms">Đăng ký</a>
                    </div>
                  </c:otherwise>
                </c:choose>
              </div>
            ...
            <div class="col-lg-6 col-xl-4">
              <div class="card mb-5 mb-xl-0">
                <div class="card-body p-5">
                  ...
                  <div class="d-grid"><a class="btn btn-outline-primary" href="#!">Đăng Ký</a></div>
                </div>
              </div>
            </div>
                    ...
                    <div class="card">
                      <div class="card-footer py-3 border-0" style="background-color: #f8f9fa;">
                        <div class="d-flex flex-start w-100">
                          <div>
                            <img class="rounded-circle shadow-1-strong me-3" src="../../../resources/static/img/avt.jpg"
                              alt="avatar" width="40" height="40" />
                            <!--Sau khi submit dữ liệu trong thẻ sẽ gán cho biến studentID-->
                            <input type="hidden" name="studentID" value="$loggedUser.studentID">
                            <p>${loggedUser.username} </p>
                          </div>
                          <div data-mdb-input-init class="form-outline w-100">
                            <!--sau khi bấm submit dữ liệu trong thẻ textarea sẽ gán cho biến name-->
                            <textarea class="form-control" id="commentText" rows="4" name="message"
                        ...
                        <div class="float-end mt-2 pt-1">
                          <button id="postCommentBtn" data-mdb-button-init data-mdb-ripple-init

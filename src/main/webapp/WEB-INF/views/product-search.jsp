            ...
            <div class="row gy-3">
                ...
                <div class="col-lg-2 col-sm-4 col-4">
                    <a href="/" target="_blank" class="float-start">
                        <img src="../../../resources/static/img/logo.png" height="40" />
                    </a>
                </div>
                <!-- Left elements -->
        ...
        <div class="container py-4">
            ...
            <nav class="d-flex mb-2">
                <h6 class="mb-0">
                    ...
                    <a href="" class="text-white-50">Shop</a>
                    <span class="text-white-50 mx-2"> > </span>
                                ...
                                <div class="row g-0">
                                    <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                                        <div
                                            ...
                                            <img src="https://cdn.tgdd.vn/Products/Images/2485/76934/bhx/xa-bong-cuc-safeguard-trang-tinh-khiet-130g-202307260909050450.jpg"
                                                class="w-100" />
                                            <a href="#!">
                                    ...
                                    <div class="col-xl-6 col-md-5 col-sm-7">
                                        ...
                                        <p class="text mb-4 mb-md-0">
                                            Short description about the product goes here, for ex its features. Lorem
                                            ipsum dolor sit amet with hapti you enter into any new area of science, you
                                            almost lorem ipsum is great text
                            ...
                            <div class="card-body">
                                <div class="row g-0">
                                    ...
                                    <div class="col-xl-6 col-md-5 col-sm-7">
                                        ...
                                        <p class="text mb-4 mb-md-0">
                                            Re-engineered Digital Crown with hapti Lorem ipsum dolor sit amet,
                                            consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                                            dolore magna aliqua tempor incididunt ut
                            ...
                            <div class="card-body">
                                <div class="row g-0">
                                    <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                                        <div
                                            class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                                            <img src="https://cdn.tgdd.vn/Products/Images/2485/76934/bhx/xa-bong-cuc-safeguard-trang-tinh-khiet-130g-202307260909050450.jpgp"
                                                class="w-100" />
                                            <a href="#!">
                                                <div class="hover-overlay">
                                                    <div class="mask"

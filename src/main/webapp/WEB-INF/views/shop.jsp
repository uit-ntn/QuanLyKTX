...
<html lang="en">
    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://vinpack.vn/uploads/details/2021/06/images/bao-bi-bot-giat-da-dang-mau-ma-va-kieu-dang.jpg" alt="..." />
                            <!-- Product details-->
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Dorm Dev Team</p></div>
        </footer>
        <!-- Bootstrap core JS-->
